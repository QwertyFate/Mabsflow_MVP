...
import CampaignAutomation from '../../components/dashboard/campaignAutomation.jsx';
...
const ContentArea = styled(Box)(({ theme }) => ({
  flex: 1,
  marginLeft: '231px', // Add left margin to account for fixed sidebar width
...
const MainDashboard = () => {
  ...
  const renderMainContent = () => {
    if (activeSidebarItem === 'campaign-automation') {
